...
from model_factory import wide_resnet
    ...
    if data_type == "images":
        if len(input_shape) == 1:
            ...
            if hparams['image_arch'] == 'resnet_sup_in1k':
                ...
                return TimmModel({
                                     'resnet_sup_in21k': 'tresnet_m_miil_in21k',
                                     # https://github.com/Alibaba-MIIL/ImageNet21K
                                     'vit_sup_in1k': 'vit_base_patch32_224.augreg_in1k',
                                     ...
                                     'vit_dino_in1k': 'vit_base_patch16_224.dino'
                ...
                return ImportedModel(imagenet_resnet50_ssl({
                                                           ...
                                                           }[hparams['image_arch']]), 2048, input_shape, hparams,
                                     hparams['pretrained'])
        else:
...
def get_whac_a_mole_model(arch, weights="IMAGENET1K_V1", num_classes=2, pretrained_checkpoint=None):
    model = torchvision.models.__dict__[arch](weights=weights)
    model.fc = nn.Linear(model.fc.in_features, num_classes)

    ret = model.load_state_dict(pretrained_checkpoint)
    print(ret)
