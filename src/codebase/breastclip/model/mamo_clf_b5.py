...
class MammoModelEfficientNet(nn.Module):
    def __init__(self, name, *, pretrained=False, in_chans=1, p=3, p_trainable=False, eps=1e-6, get_features=False):
        super(MammoModelEfficientNet, self).__init__()
