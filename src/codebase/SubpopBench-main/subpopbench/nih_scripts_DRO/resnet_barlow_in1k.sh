#!/bin/sh
#SBATCH --output=/restricted/projectnb/batmanlab/shawn24/PhD/Ladder/src/psc_logs/subpopbench/nih-GroupDRO/nih-resnet_barlow_in1k-%j.out
...
slurm_output_train1=/restricted/projectnb/batmanlab/shawn24/PhD/Ladder/src/psc_logs/subpopbench/nih-GroupDRO/nih-resnet_barlow_in1k-$CURRENT.out
...
python /restricted/projectnb/batmanlab/shawn24/PhD/Ladder/src/codebase/SubpopBench-main/subpopbench/train.py \
       ...
       --es_metric overall:AUROC --use_es \
       --image_arch "resnet_barlow_in1k" >$slurm_output_train1
