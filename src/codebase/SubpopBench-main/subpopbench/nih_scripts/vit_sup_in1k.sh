#!/bin/sh
#SBATCH --output=/restricted/projectnb/batmanlab/shawn24/PhD/Ladder/src/psc_logs/subpopbench/nih-ERM/nih-vit_sup_in1k-%j.out
...
slurm_output_train1=/restricted/projectnb/batmanlab/shawn24/PhD/Ladder/src/psc_logs/subpopbench/nih-ERM/nih-vit_sup_in1k-$CURRENT.out
