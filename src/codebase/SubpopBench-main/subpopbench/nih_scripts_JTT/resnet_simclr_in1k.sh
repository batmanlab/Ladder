#!/bin/sh
#SBATCH --output=/restricted/projectnb/batmanlab/shawn24/PhD/Ladder/src/psc_logs/subpopbench/nih-JTT/nih-resnet_simclr_in1k-%j.out
...
slurm_output_train1=/restricted/projectnb/batmanlab/shawn24/PhD/Ladder/src/psc_logs/subpopbench/nih-JTT/nih-resnet_simclr_in1k-$CURRENT.out
